                ...
                <nav id="menu_movil" className="menu_movil d-block d-sm-block d-md-none">
                    <div className="row">
                        <div className="col-5">
                            <div className="row">
                                <div className="col-6">
                                    <li className="menu_movil__item"><a className="menu_movil__link" href="#"><i className="fas fa-igloo"></i>Universidades</a></li>
                                </div>
                                <div className="col-6">
                                    <li className="menu_movil__item"><a className="menu_movil__link" href="#"><i className="fas fa-igloo"></i>Carreras</a></li>
                                </div>
                            </div>
                        </div>
                        <div className="col-2">
                        ...
                        <div className="col-5">
                            <div className="row">
                                ...
                                <div className="col-6">
                                    <li className="menu_movil__item"><a className="menu_movil__link" href="#"><i className="fas fa-igloo"></i>Ingresar</a></li>
                                </div>
                            </div>
                        </div>
                    </div>
